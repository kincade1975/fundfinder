...
import hr.betaware.fundfinder.jpa.AuditingDateTimeProvider;
import hr.betaware.fundfinder.jpa.SpringSecurityAuditorAware;

@SpringBootApplication
@EnableJpaAuditing(dateTimeProviderRef = "auditingDateTimeProvider", auditorAwareRef = "springSecurityAuditorAware")
@EnableScheduling
